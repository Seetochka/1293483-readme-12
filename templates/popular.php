    ...
    <div class="popular container">
                ...
                <ul class="popular__sorting-list sorting__list">
                    <li class="sorting__item sorting__item--popular">
                        <a class="sorting__link <?= !$active_sorting_type ? 'sorting__link--active' :''; ?> <?= $sorting_order === 'asc' ? 'sorting__link--reverse' : ''; ?>"
                           href="<?= get_query_href(['page' => null, 'sorting-type' => null, 'sorting-order' => (!$active_sorting_type and $sorting_order !== 'asc') ? 'asc' : null], '/popular.php'); ?>">
                    ...
                    <li class="sorting__item">
                        <a class="sorting__link <?= $active_sorting_type === 'likes' ? 'sorting__link--active' :''; ?> <?= $sorting_order === 'asc' ? 'sorting__link--reverse' : ''; ?>"
                           href="<?= get_query_href(['page' => null, 'sorting-type' => 'likes', 'sorting-order' => ($active_sorting_type === 'likes' and $sorting_order !== 'asc') ? 'asc' : null], '/popular.php'); ?>">
                            <span>Лайки</span>
                            <svg class="sorting__icon" width="10" height="12">
                                <use xlink:href="#icon-sort"></use>
                            </svg>
                    ...
                    <li class="sorting__item">
                        <a class="sorting__link <?= $active_sorting_type === 'date' ? 'sorting__link--active' :''; ?> <?= $sorting_order === 'asc' ? 'sorting__link--reverse' : ''; ?>"
                           href="<?= get_query_href(['page' => null, 'sorting-type' => 'date', 'sorting-order' => ($active_sorting_type === 'date' and $sorting_order !== 'asc') ? 'asc' : null], '/popular.php'); ?>">
                            <span>Дата</span>
                            <svg class="sorting__icon" width="10" height="12">
                                <use xlink:href="#icon-sort"></use>
                            </svg>
                ...
                <ul class="popular__filters-list filters__list">
                    <li class="popular__filters-item popular__filters-item--all filters__item filters__item--all">
                        <a class="filters__button filters__button--ellipse filters__button--all <?= !$active_content_type ? 'filters__button--active' : ''; ?>"
                           href="<?= get_query_href(['page' => null, 'content-type' => null, 'sorting-type' => null, 'sorting-order' => null], '/popular.php'); ?>">
                            <span>Все</span>
                        </a>
                    </li>
                    <?php foreach ($content_types as $content_type):
                        ...
                        <li class="popular__filters-item filters__item">
                            <a class="filters__button filters__button--<?= $content_type['class_name']; ?> button <?= $content_type['id'] === $active_content_type ? 'filters__button--active' : ''; ?>"
                               href="<?= get_query_href(['page' => null, 'content-type' => $content_type['id'], 'sorting-type' => null, 'sorting-order' => null], '/popular.php'); ?>">
                        ...
                        <div class="post__author">
                            <a class="post__author-link" href="/profile.php?id=<?= $post['user_id'] ?>" title="Автор">
                                ...
                                <div class="post__info">
                                    ...
                                    <time class="post__time" datetime="<?= $post['dt_add']; ?>" title="<?= date_format(date_create($post['dt_add']), 'd.m.Y H:i'); ?>"><?= format_time($post['dt_add']); ?>назад</time>
                                </div>
                            </a>
                        </div>
        ...
        <?php if ($pages_count > 1): ?>
            <div class="popular__page-links">
                <?php if ($page !== 1): ?>
                    <a class="popular__page-link popular__page-link--prev button button--gray" href="<?= get_query_href(['page' => $page === 2 ? null : $page - 1], '/popular.php'); ?>">Предыдущая страница</a>
                <?php else: ?>
                    <a></a>
                <?php endif; ?>
                <?php if ($page !== $pages_count): ?>
                    <a class="popular__page-link popular__page-link--next button button--gray" href="<?= get_query_href(['page' => $page + 1], '/popular.php'); ?>">Следующая страница</a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    </div>
