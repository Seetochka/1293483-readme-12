            ...
            <div class="post-details__wrapper post-photo">
                <div class="post-details__main-block post post--details">
                    ...
                    <div class="post__indicators">
                        ...
                        <span class="post__view"><?= $post['show_count'] . get_noun_plural_form(
                            $post['show_count'],
                            ' просмотр',
                            ' просмотра',
                            ' просмотров'
                    ...
                    <div class="comments">
                        <form class="comments__form form" method="post">
                            ...
                            <div class="form__input-section <?= !empty($errors) ?
                                'form__input-section--error' : ''; ?>">
                                <textarea class="comments__textarea form__textarea form__input"
                                          placeholder="Ваш комментарий"
                                          name="content"><?= !empty($new_comment['content']) ?
                                        ...
                                        <div class="comments__avatar">
                                            <a class="user__avatar-link"
                                               href="/profile.php?id=<?= $comments[$i]['user_id']; ?>">
                                                <img class="comments__picture"
                                                     src="<?= $comments[$i]['avatar'] ?? 'img/icon-input-user.svg'; ?>"
                                                     alt="Аватар пользователя" width="40" height="40">
                                            </a>
                                        </div>
                                        <div class="comments__info">
                                            <div class="comments__name-wrapper">
                                                ...
                                                <time class="comments__time" datetime="<?= $comments[$i]['dt_add']; ?>"
                                                      title="
                                                      <?= date_format(
                                                          date_create($comments[$i]['dt_add']),
                                                          'd.m.Y H:i'
                                                      ); ?>"><?= format_time($comments[$i]['dt_add']); ?> назад
                                                </time>
                                            </div>
                ...
                <div class="post-details__user user">
                    <div class="post-details__user-info user__info">
                        ...
                        <div class="post-details__name-wrapper user__name-wrapper">
                            ...
                            <time class="post-details__time user__time" datetime="<?= $author['dt_add']; ?>"
                                  title="
                                  <?= date_format(
                                      date_create($author['dt_add']),
                                      'd.m.Y H:i'
                                  ); ?>"><?= format_time($author['dt_add']); ?>на сайте
                            </time>
                        </div>
                    </div>
                    ...
                    <div class="post-details__user-buttons user__buttons">
                        <?php if ($author['id'] !== $user_data['id']) : ?>
                            ...
                            button
                            button--<?= !$author['is_follower'] ? 'main' : 'quartz'; ?>"
                               href="/actions/toggle-subscription.php?author_id=<?= $author['id'] ?>">
                                <?= !$author['is_follower'] ? 'Подписаться' : 'Отписаться'; ?>
                            </a>
