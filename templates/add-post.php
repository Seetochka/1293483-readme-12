        ...
        <div class="adding-post container">
            <div class="adding-post__tabs-wrapper tabs">
                ...
                <div class="adding-post__tab-content">
                    <section class="adding-post__<?= $content_types[$index]['class_name']; ?> tabs__content tabs__content--active">
                        <h2 class="visually-hidden">Форма добавления <?= $form_title[$index]; ?></h2>
                        <form class="adding-post__form form" action="/add.php" method="post" enctype="multipart/form-data">
                            <div class="form__text-inputs-wrapper">
                                <div class="form__text-inputs">
                                    <div class="adding-post__input-wrapper form__input-wrapper">
                                        <label class="adding-post__label form__label" for="<?= $content_types[$index]['class_name']; ?>-heading">Заголовок <span class="form__input-required">*</span></label>
                                        <div class="form__input-section <?= $errors['title'] ? 'form__input-section--error' :''; ?>">
                                            <input class="adding-post__input form__input" id="<?= $content_types[$index]['class_name']; ?>-heading" type="text" name="title" placeholder="Введите заголовок" value="<?= htmlspecialchars($post['title']) ?? ''; ?>">
                                    ...
                                    <div class="adding-post__input-wrapper form__input-wrapper">
                                        ...
                                        <div class="form__input-section <?= $errors['hashtag_name'] ? 'form__input-section--error' :''; ?>">
                                            <input class="adding-post__input form__input" id="video-tags" type="text" name="hashtag_name" placeholder="Введите теги"  value="<?= htmlspecialchars($post['hashtag_name']) ?? ''; ?>">
                                            <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                                            <div class="form__error-text">
                            ...
                            <?php if($content_types[$index]['class_name'] === 'photo'): ?>
                                <div class="adding-post__input-file-container form__input-container form__input-container--file">
                                    <div class="adding-post__input-file-wrapper form__input-file-wrapper">
                                        <input class="adding-post__input-file form__input-file visually-hidden" id="userpic-file-photo" type="file" name="photo" title=" ">
