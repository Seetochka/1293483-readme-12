                        ...
                        <a class="messages__contacts-tab <?= $interlocutor['id'] === $interlocutor_id ? 'messages__contacts-tab--active' : ''; ?> tabs__item <?= $interlocutor['id'] === $interlocutor_id ? 'tabs__item--active' : ''; ?>"
                           href="<?= get_query_href(['id' => $interlocutor['id']], '/messages.php'); ?>">
                            <div class="messages__avatar-wrapper">
                                <img class="messages__avatar" src="<?= $interlocutor['avatar'] ?? 'img/icon-input-user.svg'; ?>" alt="Аватар пользователя" width="60" height="60">
                                <?php if ($interlocutor['unread_messages_count'] > 0): ?>
                            ...
                            <div class="messages__info">
                                ...
                                <div class="messages__preview">
                                    ...
                                    <time class="messages__preview-time" datetime="<?= $interlocutor['dt_add']; ?>">
                                        <?= $interlocutor['date']; ?>
                                    </time>
                                </div>
                            </div>
                                    ...
                                    <div class="messages__info-wrapper">
                                        <div class="messages__item-avatar">
                                            <a class="messages__author-link" href="/profile.php?id=<?= $message['sender_id']; ?>">
                                                <img class="messages__avatar" src="<?= $message['avatar'] ?? 'img/icon-input-user.svg'; ?>" alt="Аватар пользователя" width="40" height="40">
                                            </a>
                                        </div>
                                        <div class="messages__item-info">
                                            <a class="messages__author" href="/profile.php?id=<?= $message['sender_id']; ?>">
                                                <?= $message['login']; ?>
                                            </a>
                ...
                <div class="comments">
                    <form class="comments__form form" method="post">
                        ...
                        <div class="form__input-section <?= $errors ? 'form__input-section--error' : ''; ?>">
                            <textarea class="comments__textarea form__textarea form__input" placeholder="Ваше сообщение" name="content"><?= htmlspecialchars($new_message['content']) ?? ''; ?></textarea>
